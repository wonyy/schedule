...

{
    ...
    if (self = [super init])
    {
        ...
        [self setPlacesId: placeId];
        
        [self setPhotos: arrphotos];
...
distanceInMiles:distanceInMiles
       placesId: [jsonResultDict objectForKey:@"id"]
           photos: [jsonResultDict objectForKey:@"photos"]];
