...
- (id)initWithFrame:(CGRect)frame logic:(KalLogic *)logic delegate:(id<KalViewDelegate>)delegate withTabSize:(CGSize)tabSize;
- (id)initWithPopFrame:(CGRect)frame logic:(KalLogic *)logic delegate:(id<KalViewDelegate>)delegate withTabSize:(CGSize)tabSize;
