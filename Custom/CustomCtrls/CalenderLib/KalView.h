...
- (id)initWithFrame:(CGRect)frame delegate:(id<KalViewDelegate>)delegate logic:(KalLogic *)logic withTabSize:(CGSize)tabSize;
- (id)initPopWithFrame:(CGRect)frame delegate:(id<KalViewDelegate>)delegate logic:(KalLogic *)logic withTabSize:(CGSize)tabSize;
- (BOOL)isSliding;
