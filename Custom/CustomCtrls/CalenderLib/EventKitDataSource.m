...
//    NSPredicate *predicate = [eventStore predicateForEventsWithStartDate:fromDate endDate:toDate calendars:eventStore.calendars];
...
- (BOOL)hasEventInDate:(NSDate *)date
{
    NSArray *eventsInDate = [self eventsFrom:date to:[NSDate dateWithTimeInterval:86400 sinceDate:date]];
